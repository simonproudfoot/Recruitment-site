...
var vm = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  methods: {
    // check is the user has already completed the diversity form
    ...
    saveForm: function saveForm() {
      ...
      var current = this.formTitle; // delete the token and parims
      ...
      this.hasSaved = true;
      this.loading = true, axios__WEBPACK_IMPORTED_MODULE_1___default()({
        method: 'post',
    ...
    getForm: function getForm() {
      $('input[type=checkbox]').prop("checked", false); // get form data
      ...
      for (i in this.formValue) {
        ...
        var checkboxes = document.getElementsByName(i); // find checkboxes and tick
  ...
  created: function created() {
    ...
    this.checkDiversity(); // Set default axios header
